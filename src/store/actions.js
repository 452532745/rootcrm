...
//侧边栏展示隐藏
export const handleaside = ({ commit }) => {
  commit(types.HANDLE_ASIDE)
}

export const showApp = ({ commit }) => {
  commit(types.SHOW_APP)
}

export const hiddenApp = ({ commit }) => {
  commit(types.HIDDEN_APP)
}
